...
impl MissionModel {
    ...
    pub fn from_mission(mission: &arma3_tool_shared_models::Mission) -> Self {
        Self {
...
impl MissionComponentModel {
    ...
    pub fn from_component(
        mission_id: &str,
        component: &arma3_tool_shared_models::MissionComponent,
    ) -> Self {
        Self {
            id: None,
...
impl MissionDependencyModel {
    ...
    pub fn from_dependency(
        mission_id: &str,
        dependency: &arma3_tool_shared_models::DependencyRef,
    ) -> Self {
        Self {
            id: None,
            mission_id: mission_id.to_string(),
